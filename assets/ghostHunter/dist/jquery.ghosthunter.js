...
(function(root, factory){
  ...
  $.fn.ghostHunter.defaults = {
    ...
    onPageLoad      : true,
    onKeyUp       : false,
    result_template   : "<a id='gh-{{ref}}' class='gh-search-item' href='{{link}}'><h2>{{title}}</h2><p class='gh-search-item-post-date'>{{pubDate}}</p></a>",
    info_template   : "<p class='success posts-found'>Number of posts found: {{amount}}</p>",
